...
Fold change in the total cell population (live+dead) is calculated for every successive time interval. If there are _n_ different observed time points, there would be _n-1_ time intervals. The input data should follow the below structure,
...
We have given a sample test data, taken from this [study](https://www.mdpi.com/2077-0383/8/7/911). In this case, there are three live-cell states and a dead cell state. The data were collected at six different time points in triplicates. 
...
Usage and redistribution of this matlab package with or without modification are permitted.
